import { AuthorizeSessionRequest } from '@bitzonegaming/roleplay-engine-sdk';
import { SessionInfo } from '@bitzonegaming/roleplay-engine-sdk/session/models/session-info';
