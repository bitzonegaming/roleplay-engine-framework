...
A TypeScript framework for building custom game servers on the Bitzone RolePlay Engine platform. This framework provides
...
```typescript
import {RPServer, RPServerNatives, RPServerOptions} from '@bitzonegaming/roleplay-engine-framework';
...
```typescript
import {RPServerService, OnServer, RPSessionStarted} from '@bitzonegaming/roleplay-engine-framework';
...
```typescript
import {RPServerEvents} from '@bitzonegaming/roleplay-engine-framework';
...
```typescript
import {RPServerHooks} from '@bitzonegaming/roleplay-engine-framework';
...
```typescript
import {RPServerContext, RPServerContextOptions} from '@bitzonegaming/roleplay-engine-framework';
...
```typescript
import {RPServerService} from '@bitzonegaming/roleplay-engine-framework';
...
```typescript
import {SessionService} from '@bitzonegaming/roleplay-engine-framework';
...
The framework provides numerous built-in events that you can listen to. For a complete list of available events and their payloads, see:

📄 **[RPServerEvents Interface](src/server/core/events/events.ts)** - Complete event definitions with TypeScript types

## Built-in Hooks

The framework provides built-in hooks for intercepting application flow. For the current list of available hooks and their signatures, see:
...
```typescript
import {ApiController, ApiRoute} from '@bitzonegaming/roleplay-engine-framework';
...
For detailed API documentation and advanced examples, visit our [documentation site](https://docs.bitzone.com).
